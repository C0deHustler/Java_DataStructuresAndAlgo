// Logic and code explained in Anuj Bhaiya's video
// https://www.youtube.com/watch?v=X0G5jEcvroo

// Problem - https://leetcode.com/problems/majority-element/

public class Prepbytes_Hard_MajorityElement_MooresVotingAlgo {
    public static void main(String[] args){
        ...
        int ansIndex = 0;  // assuming the first element of array as Majority Element initially
        ...
        // Separate code for checking, that the majority element(i.e. element art ansIndex) we are getting at the end,
        // whether it is the Majority element or not
        int newCount = 0;
